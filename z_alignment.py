#Note: Fiji macro only recognize path name r"X:/XX/XX/XXX/"!!!!!!!!!!!!!!!!!!!!!!!!!
import os
import time
import glob
import sys
...
if __name__ == "__main__":
    ...
    #exp_folder = r"Y:/Chenghang/06_Testing/GUI_test/"
    z_align(exp_folder, alignment_channel)
