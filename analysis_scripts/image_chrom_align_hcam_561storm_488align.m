...
for slice = 0:slices
filename.storm488 = strcat(ISanalysisfolder,sprintf('%04d',slice),'/rawimages/for_matlab/488storm',sprintf('%03d',slice),'.tiff');
filename.storm561 = strcat(ISanalysisfolder,sprintf('%04d',slice),'/rawimages/for_matlab/561storm',sprintf('%03d',slice),'.tiff');
filename.storm647 = strcat(ISanalysisfolder,sprintf('%04d',slice),'/rawimages/for_matlab/647storm',sprintf('%03d',slice),'.tiff');
filename.storm750 = strcat(ISanalysisfolder,sprintf('%04d',slice),'/rawimages/for_matlab/750storm',sprintf('%03d',slice),'.tiff');
