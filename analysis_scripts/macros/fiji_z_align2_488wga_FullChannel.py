...
conv_488_folder = exp_folder + "cropped/conv_488/"
conv_488_folder_ds = exp_folder + "cropped/for_align_ds/"
extra_folder = exp_folder + "cropped/storm_561_488"
...
for i in range(num_sections):
	...
	for j in range(5):
		...
		if patch_num == 2:
			IJ.run(imp2, "8-bit", "")
			IJ.saveAs(imp2, "TIF", (exp_folder + "elastic_align/conv_488/" + basename[:-4] + ".tif"))
			IJ.run(imp4, "8-bit", "")
			IJ.saveAs(imp4, "TIF", (exp_folder + "elastic_align/conv_488_ds/" + basename[:-4] + ".tif"))
			IJ.run("Close All", ""); 
		...
		if patch_num ==3:
			IJ.saveAs(imp2, "PNG", (exp_folder + "elastic_align/storm_561_488/" + basename[:-4] + ".png"))
			IJ.saveAs(imp4, "PNG", (exp_folder + "elastic_align/storm_561_488_ds/" + basename[:-4] + ".png"))
	print (basename)    
